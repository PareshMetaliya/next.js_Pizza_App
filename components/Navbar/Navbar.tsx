...
function Navbar() {
  ...
  return (
    <>
      <nav className="container fixed top-0 z-20 bg-navbar max-md:h-[6vh] md:h-[10vh] w-[100vw] border-b-[1px] border-customGrayDark flex  justify-between items-center">
