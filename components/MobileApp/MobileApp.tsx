    ...
    return (
        <section className="container ">
            <div className="bg-light-yellow flex p-20 items-center justify-evenly max-md:flex-col">
                <div className="flex justify-center flex-2 items-center relative m-6">
                    <Image
                ...
                <div className="flex justify-center gap-6 flex-1 flex-col items-center max-md:mt-6 max-xs:mt-12 p-4">
